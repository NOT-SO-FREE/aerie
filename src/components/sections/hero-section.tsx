...
const HeroSection = () => {
  return (
    <div className="max-w-lg mx-auto text-center">
      ...
      <h1 className="text-lg md:text-xl font-bold text-[#173827] mb-1.5 px-2 relative -mt-4">
      ...
      <p className="text-xs md:text-sm text-[#21402f] mb-2 font-medium px-2 relative">
